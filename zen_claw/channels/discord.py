...
class DiscordChannel(BaseChannel):
    ...
    async def _handle_message_create(self, payload: dict[str, Any]) -> None:
        ...
        for attachment in (payload.get("attachments") or [])[:MAX_MEDIA_ATTACHMENTS]:
            ...
            try:
                ...
                transcription = await self._maybe_transcribe_media(file_path, content_type)
                if transcription:
    ...
    async def _maybe_transcribe_media(self, file_path: Path, content_type: str | None) -> str:
        """Transcribe audio/video attachments when Groq key is available."""
        ...
        try:
            ...
            logger.warning(f"Discord media transcription failed: {e}")
            return ""
    ...
    @staticmethod
    def _ref_type_from_content_type(content_type: str | None) -> str:
